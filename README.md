...
[![Go Reference](https://pkg.go.dev/badge/github.com/RainyPixel/gitverse-sdk-go/v5.svg)](https://pkg.go.dev/github.com/RainyPixel/gitverse-sdk-go/v5)
...
```bash
go get github.com/RainyPixel/gitverse-sdk-go/v5
```
...
import (
    ...
    gitverse "github.com/RainyPixel/gitverse-sdk-go/v5"
)
